...
echo "0 blue helmet" >> "${OUTPUT_DIR}/labels.txt"
echo "1 white helmet" >> "${OUTPUT_DIR}/labels.txt"
echo "2 yellow helmet" >> "${OUTPUT_DIR}/labels.txt"
echo "3 red helmet" >> "${OUTPUT_DIR}/labels.txt"
echo "4 no helmet" >> "${OUTPUT_DIR}/labels.txt"
